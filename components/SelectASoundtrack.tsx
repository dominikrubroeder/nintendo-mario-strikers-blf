                ...
                {soundtracksData.map((soundtrack) => (
                  ...
                  >
                    <span className="flex items-center gap-1">
                      <SpeakerWaveIcon className="w-3 h-3 text-themed themed:text-white" />
                      {soundtrack.title}
                    </span>
